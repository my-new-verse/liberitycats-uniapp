...
const lightVars: Record<string, string> = {
  ...
  '--activity-popup-no-remind-color': 'rgba(255, 255, 255, 0.88)',
  '--revenueHelpClose-bg-color': '#f7f3f0',
  '--revenueHelpDescription-color': '#6f5c50',
  '--revenueHelpDescription-bg-color': '#fff8f3',
  '--revenueHelpDescription-border-color': '#ffe6d4',
  '--pointBox-active-bg-color': '#fffaf8',
  '--share-container-bg': 'linear-gradient(to top right, #ffffff 0%, #ffffff 60%, #ffecd8 100%)',
  '--poster-divider-color': '#ffecd8',
  '--wot-button-info-plain-normal-color': 'rgba(0, 0, 0, 0.85)',
  '--wot-picker-toolbar-title-color': 'rgba(0, 0, 0, 0.85)',
  '--wot-picker-column-color': 'rgba(0, 0, 0, 0.85)',
  '--wot-button-info-plain-border-color': 'rgba(0, 0, 0, 0.45)',
  '--opBox-border-color': '#e7e7e7',
  '--wot-picker-toolbar-cancel-color': '#666666',
  ...
  '--l-editor-bg': '#ffffff',
  '--l-editor-surface': '#f3f3f4',
  '--l-editor-text': '#261000',
  '--l-editor-placeholder': 'rgba(38, 16, 0, 0.3)',
  '--l-editor-disabled-bg': '#eeeeee',
  '--l-editor-text-muted': '#999999',
  '--l-editor-btn-disabled-bg': '#e0e0e0',
  '--l-editor-btn-disabled-color': '#999999',
  '--l-editor-primary': '#ff6b03',
...
const darkVars: Record<string, string> = {
  ...
  '--activity-popup-no-remind-color': 'rgba(0, 0, 0, 0.88)',
  '--revenueHelpClose-bg-color': '#1c1a18',
  '--revenueHelpDescription-color': '#b49c8c',
  '--revenueHelpDescription-bg-color': '#2a2522',
  '--revenueHelpDescription-border-color': '#7a5e4b',
  '--pointBox-active-bg-color': '#24211f',
  '--share-container-bg': '#2d2d2d',
  '--poster-divider-color': '#4e4e4e',
  '--wot-button-info-plain-normal-color': 'rgba(255, 255, 255, 0.85)',
  '--wot-picker-toolbar-title-color': 'rgba(255, 255, 255, 0.85)',
  '--wot-picker-column-color': 'rgba(255, 255, 255, 0.85)',
  '--wot-button-info-plain-border-color': 'rgba(255, 255, 255, 0.45)',
  '--opBox-border-color': '#44403d',
  '--wot-picker-toolbar-cancel-color': '#b6b6b6',
  ...
  '--l-editor-bg': '#2d2d2d',
  '--l-editor-surface': '#1e1e1e',
  '--l-editor-text': '#e0e0e0',
  '--l-editor-placeholder': 'rgba(226, 226, 226, 0.5)',
  '--l-editor-disabled-bg': '#242424',
  '--l-editor-text-muted': '#888888',
  '--l-editor-btn-disabled-bg': '#4f4f4f',
  '--l-editor-btn-disabled-color': '#999999',
  '--l-editor-primary': '#ff6b03',
  '--l-editor-btn-active-color': '#ffffff',
